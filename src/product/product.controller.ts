...
export class ProductsController {
  ...
  // you only need the name of the ms service to inject it
  // the send method is used to send a message to the microservice it waits for the response, it's a observable
